...
//1.-Crear un estado inicial para reducer
const initialState = {
  user: [
    {
      name: "alex",
...
//2.-Crear una variable que contenga createStore y pasamos como argumentos el reducer(archivo creado con una funcion) y el estado inicial
const store = createStore(reducer, initialState);
console.log(store);
ReactDOM.render(
  //3.-Agregamos como prop el store, asignamos el nombre de la prop como store.(Siguiente paso ir a nuestra app)
